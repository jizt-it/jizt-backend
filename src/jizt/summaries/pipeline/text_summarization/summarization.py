        ...
        * Beam-search multinomial sampling.
        ...
        Args:
            ...
            top_p (:obj:`float`, `optional`, defaults to 1.0):
                ...
                probabilities that add up to :obj:`top_p` higher are kept for
                generation.
            repetition_penalty (:obj:`float`, `optional`, defaults to 1.0):
                The parameter for repetition penalty. 1.0 means no penalty. See
                `this paper <https://arxiv.org/pdf/1909.05858.pdf>`__ for more
                details.
            bad_words_ids(:obj:`List[List[int]]`, `optional`):
                List of token ids that are not allowed to be generated. In order
                to get the tokens of the words should not appear in the
                generated text, use
            ...
            use_cache: (:obj:`bool`, `optional`, defaults to :obj:`True`):
                ...
                attentions (if applicable to the model) speed up decoding.
