    ...
    def preprocess(
        ...
        Args:
            ...
            return_as_list (:obj:`bool`):
                If :obj:`True` the text is split into sentences and the method
                returns a list containing those sentences. If :obj:`False`, it
                returns the text pre-processed as a single string.
